/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e013a19ef6710ba17dcca8b3f560a539)
...
declare namespace Cloudflare {
	...
	interface Env {
		IMAGES: R2Bucket;
		DB: D1Database;
		PR_WORKFLOW: Workflow<Parameters<import("./src/index").PRVisualWorkflow['run']>[0]['payload']>;
	}
}
